...
export const MainNavigation = () => {
  ...
  return (
    <header className="fixed z-50 w-full border-b border-gray-200 bg-white bg-opacity-90 backdrop-blur backdrop-filter dark:border-gray-800 dark:bg-gray-950">
      <div className="container mx-auto flex h-16 w-full items-center justify-between px-4 md:px-8 lg:px-16">
        <div className="flex items-center">
          <Link href="/">
            <a className="mr-3 font-bold text-2xl text-blue-500 inline-flex items-center">
              <Logo />
              <span className="ml-2 text-transparent text-2xl font-extrabold  bg-clip-text bg-gradient-to-r to-cyan-500 from-blue-500 background-animate">RootSocket</span>
            </a>
          </Link>
        </div>
